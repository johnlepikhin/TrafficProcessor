...
src/levels/%.o: ../src/levels/%.cpp
	...
	g++ -I../../cpp-sparse-ropes/src -O3 -Wall -c -fmessage-length=0 -std=c++11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
...
src/levels/ParserPacketIPv4.o: ../src/levels/ParserPacketIPv4.cpp
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C++ Compiler'
	g++ -I../../cpp-sparse-ropes/src -O3 -Wall -c -fmessage-length=0 -std=c++11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"src/levels/ParserPacketIPv4.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
